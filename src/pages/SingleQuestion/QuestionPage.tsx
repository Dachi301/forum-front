    ...
    return (
        <MainLayout>
            <div className={'flex flex-col gap-5'}>
                ...
                />
                <div className={'w-[75%]'}>
                    <h1 className={'text-[18px] text-center text-[#808080] font-bold leading-6 tracking-wider'}>
                        Suggestions
                    </h1>
                </div>
                <div className={'flex flex-col gap-3 w-[75%] py-7 px-10 bg-white shadow-default'}>
                    <textarea placeholder={'Type here your wise suggestion'}
                              className={'w-full outline-0 text-[12px] font-light rounded border-[2px] border-[#EAEAEA] pt-2 pb-4 px-3'}
