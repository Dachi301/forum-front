    ...
    return (
        <>
            {mainPage ? (
                <Link
                    to={`/questions/${id}`}
                    className='shadow-default flex flex-col gap-4 bg-white w-[75%] rounded py-6 px-7'>
                    <div className='flex items-center'>
                        <div className='flex items-center gap-4'>
                            <img className='w-10 h-10 rounded-[40px]' src={userImageSrc} alt='Profile Picture'/>
                ...
                <div
                    ...
                    <div className='flex items-center justify-between'>
                        ...
                        <Button
                            ...
                            className={'flex items-center gap-3 px-5 py-2 bg-[#1682FD] rounded text-white text-xs'}
                        />
                    </div>
                </div>
            )}
